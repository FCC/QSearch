...
Convert pipe delimited docket info to json file
...
Examples:
	python etl_docket_json.py -v -l "|" -k 0 -p docket -f /codedata/data/datahash/hotdockets.txt -t /codedata/data/datahash/hotdockets.json
	python etl_docket_json.py -v -l "|" -k 0 -p docket -f /codedata/data/datahash/hotdockets.txt -t /codedata/data/datahash/hotdockets.json	
