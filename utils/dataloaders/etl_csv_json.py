...
Convert comma delimited file info to json file
...
molds = {
	...
	'person': ['name', 'company'],
	'callsign': ["WSBS-TV callsign","-","DT","3","DA","","3","-","LIC","city","state","country","BLCDT  -20051031AAH","1. kW","-","54.0","-","72053","N","24","33","18.00","W","81","48","7.00","company","0.00 km","0.00 mi","0.00 deg","54. m","H","69987","75.","1030880","51.","1094562",""]
	}
...
Examples:
	python etl_csv_json.py -v -l "," -k 0 -p acronym -f /codedata/data/datahash/acronyms.csv
